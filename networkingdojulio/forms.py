...
from networkingdojulio.models import Usuario
...
class FormEditarPerfil(FlaskForm):
    ...
    curso_vba = BooleanField('Dança')
    curso_powerbi = BooleanField('Power BI')
    curso_python = BooleanField('Python')
    curso_ppt = BooleanField('Cantar')
    curso_sql = BooleanField('Cozinhar')
...
class FormCriarPost(FlaskForm):
    ...
    botao_edit = SubmitField('Editar Post')
